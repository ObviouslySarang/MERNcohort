  ...
  return (
    ...
    <div>
      ...
      <form  onSubmit ={(e) => submitHandler(e)}>
        ...
        <p> Want to join our Fleet? <Link to='/captain/signup' className='text-blue-600 '>Register as Captain</Link></p>

      </form>
    </div>
    <div>
      <Link to='/login' className='bg-[#f8953e] text-black flex items-center justify-center font-semibold w-full py-3 rounded mt-4'> Sign in as User </Link>
    </div> 
  </div>
  )
}
